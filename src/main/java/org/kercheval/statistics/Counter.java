 ...
 * the factory method {@link Counter#getCounter(String, String, String, Counter...)} and then obtained
    ...
    implements CounterMBean
{
     ...
     * <p>
     *
     * @param domain the JMX domain to register this counter for
     * @param type the JMX type for this counter
     ...
     */
    public static Counter getCounter(final String domain, final String type, final String name, final Counter... parents)
    {
        synchronized (COUNTER_MAP)
        {
            ...
            if (null == newCounter)
            {
                newCounter = new Counter(domain, type, name, parents);
    ...
    {
        return getCounter("org.kercheval", "Counter", name, (Counter[]) null);
    }

    private final AtomicLong count = new AtomicLong(0);
    private final Counter[] parents;

    private Counter(final String domain, final String type, final String name, final Counter... parents)
    {
